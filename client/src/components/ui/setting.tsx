...
export interface SettingsDrawerProps {
  ...
  // custom color picker (default set to #06b6d4)
  customColor?: string;
...
export default function SettingsDrawer({
  ...
  primarySkin,
  setPrimarySkin,
  customColor = "#06b6d4", // Default set to cyan (#06b6d4)
  setCustomColor,
}: SettingsDrawerProps) {
  ...
  const primarySkins = [
    {
      key: "default",
      label: tDefault2,
      gradient: "from-cyan-400 to-sky-500", // Swapped to Cyan
    },
    {
      key: "bluelight",
      label: tBlueLight,
    ...
    { key: "pink", label: tPink, gradient: "from-pink-400 to-rose-400" },
    {
      key: "cyan",
      label: tGreen,
      gradient: "from-emerald-400 to-teal-500", // Swapped to Green
    },
    {
      key: "yellow",
      label: tYellow,
      ...
      >
        ...
        <div className="p-5 space-y-6 overflow-y-auto h-full pb-24 text-xs">
          ...
          <div>
            ...
            {/* ── Custom color picker (Default: #06b6d4) ── */}
